...
# This file finds genes that are *mostly* absent in arrays and 
# returns write a new data frame without these genes
# Here, mostly absent means that a gene is absent in at least 
# 2 out of 3 replicates per compound and absent in all compounds
